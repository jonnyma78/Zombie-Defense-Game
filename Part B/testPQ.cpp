...
/*     eecsPQ.push(6);
cout<<"START OF"<<endl;
cout<<eecsPQ.size()<<endl;
   for(int i = 0; i < 6;i++){
        cout<<eecsPQ.top()<<endl;
        eecsPQ.pop();
    }  
    cout<<"THE END"<<endl;*/
...
/*      for(int i = 0; i < 8; i++){
    ...
    assert(eecsPQ.top() == 120);
    eecsPQ.pop();
    assert(eecsPQ.top() == 100);
    eecsPQ.pop();
    assert(eecsPQ.top() == 85);
    eecsPQ.pop();
    assert(eecsPQ.top() == 75);
    eecsPQ.pop();
...
void testUpdatePriorities() {
  ...
  /*   
    ...
    cout<<"Update priorities successful"<<endl;
